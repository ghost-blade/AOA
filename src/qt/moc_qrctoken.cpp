...
QT_MOC_LITERAL(23, 301, 11) // "removeToken"
    ...
    "QRCToken\0on_goToSendTokenPage\0\0"
...
void QRCToken::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QRCToken *_t = static_cast<QRCToken *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QRCToken::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QRCToken.data,
      qt_meta_data_QRCToken,  qt_static_metacall, nullptr, nullptr}
};
