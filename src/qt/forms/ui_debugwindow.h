...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        gridLayout->addWidget(numberOfBlocks, 15, 1, 1, 2);
        ...
        gridLayout->addWidget(mempoolSize, 21, 1, 1, 1);
        ...
        gridLayout->addWidget(labelNumberOfTransactions, 20, 0, 1, 1);
        ...
        gridLayout->addWidget(networkName, 10, 1, 1, 2);

        labelBlockChain = new QLabel(tab_info);
        labelBlockChain->setObjectName(QStringLiteral("labelBlockChain"));
        labelBlockChain->setFont(font);

        gridLayout->addWidget(labelBlockChain, 13, 0, 1, 1);
        ...
        gridLayout->addWidget(labelLastBlockTime, 16, 0, 1, 1);
        ...
        gridLayout->addWidget(numberOfConnections, 11, 1, 1, 2);
        ...
        gridLayout->addWidget(mempoolNumberTxs, 20, 1, 1, 1);
        ...
        gridLayout->addWidget(lastBlockTime, 16, 1, 1, 2);
        ...
        hLine4 = new QFrame(tab_info);
        hLine4->setObjectName(QStringLiteral("hLine4"));
        hLine4->setFrameShape(QFrame::HLine);
        hLine4->setFrameShadow(QFrame::Sunken);

        gridLayout->addWidget(hLine4, 19, 0, 1, 3);
        ...
        hLine3 = new QFrame(tab_info);
        hLine3->setObjectName(QStringLiteral("hLine3"));
        hLine3->setFrameShape(QFrame::HLine);
        hLine3->setFrameShadow(QFrame::Sunken);

        gridLayout->addWidget(hLine3, 14, 0, 1, 3);
        ...
        hLine2 = new QFrame(tab_info);
        hLine2->setObjectName(QStringLiteral("hLine2"));
        hLine2->setFrameShape(QFrame::HLine);
        hLine2->setFrameShadow(QFrame::Sunken);

        gridLayout->addWidget(hLine2, 9, 0, 1, 3);

        hLine = new QFrame(tab_info);
        ...
        horizontalLayout_6->addWidget(labelDebugLogfile);
        ...
        horizontalLayout_6->addWidget(openDebugLogfileButton);


        gridLayout->addLayout(horizontalLayout_6, 23, 0, 1, 3);
        ...
        fontSmallerButton->setIconSize(QSize(16, 16));
        ...
        fontBiggerButton->setIconSize(QSize(16, 16));
        ...
        horizontalLayout_3->setContentsMargins(30, 20, 30, 20);
    ...
    void retranslateUi(QWidget *RPCConsole)
    {
        ...
        labelBlockChain->setText(QApplication::translate("RPCConsole", "Block chain", nullptr));
        ...
        labelGeneral->setText(QApplication::translate("RPCConsole", "General", nullptr));
