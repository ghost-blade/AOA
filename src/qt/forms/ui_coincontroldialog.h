...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 AUROLA"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 AUROLA"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 AUROLA"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 AUROLA"));
