...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("AOA");
    case mBTC: return QString("mAOA");
    case uBTC: return QString::fromUtf8("μAOA");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("AOAs");
    case mBTC: return QString("Milli-AOAs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-AOAs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
